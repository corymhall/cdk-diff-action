...
var tokenProviders = __webpack_require__(77302);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(80620); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(26868);
...
const bdd_1 = __webpack_require__(28142);
...
var middlewareHostHeader = __webpack_require__(63287);
var middlewareLogger = __webpack_require__(61937);
var middlewareRecursionDetection = __webpack_require__(25173);
var middlewareUserAgent = __webpack_require__(71656);
...
var httpAuthSchemeProvider = __webpack_require__(26711);
var runtimeConfig = __webpack_require__(69014);
var regionConfigResolver = __webpack_require__(37318);
var protocolHttp = __webpack_require__(72356);
var schemas_0 = __webpack_require__(80960);
var errors = __webpack_require__(98036);
var SSOServiceException = __webpack_require__(85124);
...
const SSOServiceException_1 = __webpack_require__(85124);
...
const runtimeConfig_shared_1 = __webpack_require__(20959);
...
const httpAuthSchemeProvider_1 = __webpack_require__(26711);
const endpointResolver_1 = __webpack_require__(93585);
const schemas_0_1 = __webpack_require__(80960);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(98036);
const SSOServiceException_1 = __webpack_require__(85124);
...
var client = __webpack_require__(8721);
var httpAuthSchemes = __webpack_require__(13364);
var propertyProvider = __webpack_require__(71238);
var sharedIniFileLoader = __webpack_require__(94964);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 458).then(__webpack_require__.t.bind(__webpack_require__, 70458, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 458).then(__webpack_require__.t.bind(__webpack_require__, 70458, 23));
