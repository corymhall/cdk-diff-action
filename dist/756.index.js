...
var tokenProviders = __webpack_require__(4135);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(44863); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(10529);
...
const bdd_1 = __webpack_require__(53329);
...
var middlewareHostHeader = __webpack_require__(96876);
var middlewareLogger = __webpack_require__(81416);
var middlewareRecursionDetection = __webpack_require__(30014);
var middlewareUserAgent = __webpack_require__(81589);
...
var httpAuthSchemeProvider = __webpack_require__(80378);
var runtimeConfig = __webpack_require__(99275);
var regionConfigResolver = __webpack_require__(98233);
var protocolHttp = __webpack_require__(72356);
var schemas_0 = __webpack_require__(4889);
var errors = __webpack_require__(47149);
var SSOServiceException = __webpack_require__(6075);
...
const SSOServiceException_1 = __webpack_require__(6075);
...
const runtimeConfig_shared_1 = __webpack_require__(89432);
...
const httpAuthSchemeProvider_1 = __webpack_require__(80378);
const endpointResolver_1 = __webpack_require__(85476);
const schemas_0_1 = __webpack_require__(4889);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(47149);
const SSOServiceException_1 = __webpack_require__(6075);
...
var client = __webpack_require__(89294);
var httpAuthSchemes = __webpack_require__(78745);
var propertyProvider = __webpack_require__(71238);
var sharedIniFileLoader = __webpack_require__(94964);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 621).then(__webpack_require__.t.bind(__webpack_require__, 88621, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 621).then(__webpack_require__.t.bind(__webpack_require__, 88621, 23));
