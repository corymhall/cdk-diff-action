...
const fromWebToken_1 = __webpack_require__(25343);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(15794)));
...
var fromTokenFile = __webpack_require__(13753);
var fromWebToken = __webpack_require__(25343);
