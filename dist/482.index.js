...
const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 492).then(__webpack_require__.bind(__webpack_require__, 85492));
        ...
        Environment: async (options) => {
            ...
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 54305, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 535).then(__webpack_require__.t.bind(__webpack_require__, 15535, 23));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 167).then(__webpack_require__.t.bind(__webpack_require__, 88167, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 369).then(__webpack_require__.t.bind(__webpack_require__, 85369, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.all(/* import() */[__webpack_require__.e(535), __webpack_require__.e(625)]).then(__webpack_require__.t.bind(__webpack_require__, 6625, 23)).then(({ fromTokenFile }) => fromTokenFile({
