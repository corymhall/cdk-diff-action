...
const fromWebToken_1 = __webpack_require__(56686);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(15535)));
...
var fromTokenFile = __webpack_require__(57174);
var fromWebToken = __webpack_require__(56686);
