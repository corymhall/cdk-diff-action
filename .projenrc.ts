    ...
    inputs: {
      ...
      ignoreAssetChanges: {
        description: [
          ...
          '',
          'When true, a resource whose properties changed *only* in asset',
          'hashes (e.g. a Custom::CDKBucketDeployment SourceObjectKeys, a',
          'Lambda Code asset, or a custom-resource CodeHash) is dropped from',
          'the diff before it is counted, rendered, or classified. This keeps',
          'routine content/asset rebuilds from showing up as updates and from',
          'tripping the destructive-changes gate (asset replacements are',
          'reported by cloudformation-diff as MAY_REPLACE).',
          '',
